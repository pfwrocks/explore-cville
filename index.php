...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand" href="#page-top">Explore C'Ville</a>
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                <!-- Masthead Heading-->
                <h1 class="masthead-heading text-uppercase mb-0">Explore C'Ville</h1>
                <!-- Icon Divider-->
                ...
                <!-- Masthead Subheading-->
                <p class="masthead-subheading font-weight-light mb-0">A vacation in your own backyard</p>
            </div>
        </header>
        ...
        <div class="copyright py-4 text-center text-white">
            <div class="container"><small>Copyright &copy; Explore C'ville 2021</small></div>
        </div>
        <!-- Bootstrap core JS-->
